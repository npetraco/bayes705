...
def postprocess(temperature=1., numResampleLogX=1, plot=True, loaded=[],
    ...
    # np.savetxt("/Users/npetraco/latex/class/fos705/Applied_Bayes/R/bayes705/tests/Dnest_Bullard_spike_test/file_logl_levels.csv", logl_levels, delimiter=",")
    # np.savetxt("/Users/npetraco/latex/class/fos705/Applied_Bayes/R/bayes705/tests/Dnest_Bullard_spike_test/file_logl_samples.csv", logl_samples, delimiter=",")
    ...
    np.savetxt("/Users/npetraco/latex/class/fos705/Applied_Bayes/R/bayes705/tests/Dnest_Bullard_spike_test/file_sandwhich.csv", sandwich, delimiter=",")
